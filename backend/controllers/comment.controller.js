...
export const deleteComment = async (req, res)=>{
    try {
        ...
        res.status(500).json({success:false, message:"Error deleting coment", error: error.message})
    }
}
...
export const editComment = async (req, res) =>{
    try {
        ...
        await comment.save()
        res.status(200).json({success:true, message:"Comment updated succesfully", comment})
    } catch (error) {
        console.log(error);
