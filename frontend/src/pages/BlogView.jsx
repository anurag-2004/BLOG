...
const BlogView = () => {
    ...
    const likeOrDislikeHandler = async () => {
        try {
            ...
            const res = await axios.get(`https://blog-avtx.onrender.com/api/v1/blog/${selectedBlog._id}/${action}`, { withCredentials: true })
            if (res.data.success) {
            ...
            <div className='max-w-6xl mx-auto p-10'>
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbItem>
                            <BreadcrumbLink href="/docs/components">Blogs</BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                ...
                <div className='my-8'>
                    ...
                    <div className='flex items-center justify-between flex-wrap gap-4'>
                        ...
                        <p className='text-sm text-muted-foreground'>Publsihed on {changeTimeFormat(selectedBlog.createdAt)}• 8 min read</p>
                    </div>
                </div>
                {/* featured image */}
