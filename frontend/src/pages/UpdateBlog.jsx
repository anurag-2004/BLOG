...
const UpdateBlog = () => {
    ...
    const updateBlogHandler = async ()=>{
        ...
        try {
            ...
            const res = await axios.put(`https://blog-avtx.onrender.com/api/v1/blog/${id}`, formData, {
                headers:{
    ...
    const togglePublishUnpublish = async ()=>{
        try {
            const res = await axios.patch(`https://blog-avtx.onrender.com/api/v1/blog/${id}`, {
                // params:{
                //     action
                // },
                withCredentials:true
    ...
    const deleteBlog = async ()=>{
        try {
           const res = await axios.delete(`https://blog-avtx.onrender.com/api/v1/blog/delete/${id}`,{withCredentials:true})
           if(res.data.success){
